...
>
	<svelte:fragment slot="slide" let:item>
		...
		<div class="col-span sm:[--span:12] lg:[--span:10] xl:[--span:8] mx-auto mt-[48px]">
			<ImageWrapper
				className="w-full"
			...
			>
				{#each currentItem?.artist.sort( (a, b) => getLastName(a.title).localeCompare(getLastName(b.title)) ) as artist}
					...
					>
						...
						<div
							class="*:mobile-small-serif *:sm:small-serif flex flex-col gap-[18px] indent-[24px] *:2xl:text-[14px]!"
						>
